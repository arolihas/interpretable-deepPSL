...
class Net(nn.Module):
    def __init__(self, params):
        ...
        self.w = nn.Linear(params.lstm_hidden_dim*params.n_layers,self.attention_size,bias=False)
