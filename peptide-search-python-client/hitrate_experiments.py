...
lstm1_attn = 'above_top1std_subsequences_testData_avgLens5.csv'
lstm1_rand ='random_above_top1std_subsequences_testData_avgLens5.csv'
lstm1_perm ='permute_above_top1std_subsequences_testData_avgLens5.csv'
